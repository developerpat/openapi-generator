...
public class SpringCodegen extends AbstractJavaCodegen
    ...
    public static final String FALLACK_PACKAGE = "fallbackPackage";
    ...
    protected String fallbackPackage = "org.openapitools.fallback";
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(FALLACK_PACKAGE)) {
            this.setFallbackPackage((String) additionalProperties.get(FALLACK_PACKAGE));
        } else {
            additionalProperties.put(FALLACK_PACKAGE, fallbackPackage);
        }
        ...
        if (!this.interfaceOnly) {
            ...
            if (library.equals(SPRING_CLOUD_LIBRARY)) {
                ...
                supportingFiles.add(new SupportingFile("clientFallback.mustache",
                       (sourceFolder + File.separator + fallbackPackage).replace(".", java.io.File.separator), "ClientFallback.java"));
